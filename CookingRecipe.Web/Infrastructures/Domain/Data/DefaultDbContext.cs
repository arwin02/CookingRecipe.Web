        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            List<User> users = new List<User>()
            {
                new User()
                {
                            ...
                            Password = BCrypt.BCryptHelper.HashPassword("1234", salt),
            ...
            List<Instruction> instructions = new List<Instruction>()
            {
                new Instruction()
                {
                    Id = Guid.Parse("b2152e67-b875-4a9d-a5ee-662b73ea6caf"),
                    CookingId = Guid.Parse("8b578d2c-8819-4c50-bf9a-ab33cd6a1ea4"),
                ...
                new Instruction()
                {
                   Id = Guid.Parse("7740c040-9f5e-4bd8-ae72-d2a6f634ab99"),
                   CookingId = Guid.Parse("8b578d2c-8819-4c50-bf9a-ab33cd6a1ea4"),
                ...
                new Instruction()
                {
                   Id = Guid.Parse("414ee824-29f6-4679-b43b-7f70e9f00f2a"),
                   CookingId = Guid.Parse("8b578d2c-8819-4c50-bf9a-ab33cd6a1ea4"),
                ...
                new Instruction()
                {
                   Id = Guid.Parse("9c4c3bb7-1cf5-4cbe-9ebb-d83555f88426"),
                   CookingId = Guid.Parse("8b578d2c-8819-4c50-bf9a-ab33cd6a1ea4"),
                ...
                new Instruction()
                {
                   Id = Guid.Parse("95466927-2a0b-4594-8f6a-76d4504e5b84"),
                   CookingId = Guid.Parse("8b578d2c-8819-4c50-bf9a-ab33cd6a1ea4"),
                ...
                new Instruction()
                {
                    Id = Guid.Parse("75a015df-929d-4bda-bc7f-dbd78b3860b5"),
                    CookingId = Guid.Parse("8b578d2c-8819-4c50-bf9a-ab33cd6a1ea4"),
                ...
                new Instruction()
                {
                  Id = Guid.Parse("d8baa664-dafe-45e5-b234-724c80810dec"),
                  CookingId = Guid.Parse("8b578d2c-8819-4c50-bf9a-ab33cd6a1ea4"),
                ...
                new Instruction()
                {
                    Id = Guid.Parse("63db5447-986e-4136-b81f-afa50230d24f"),
                    CookingId = Guid.Parse("8b578d2c-8819-4c50-bf9a-ab33cd6a1ea4"),
